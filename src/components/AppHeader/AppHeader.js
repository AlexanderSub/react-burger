      ...
      <nav className={AppHeaderStyles.nav}>
        <ul className={AppHeaderStyles.list}>
          <li className={AppHeaderStyles.navItem}>
            <NavLink exact="true" to={URL_MAIN} className={AppHeaderStyles.button} activeClassName={AppHeaderStyles.active}>
              <BurgerIcon type="secondary"/>
              <p className={`text text_type_main-default text_color_inactive ml-2`}>Конструктор</p>
            </NavLink>
          </li>
          <li className={AppHeaderStyles.navItem}>
            <NavLink to={URL_ORDERS} className={AppHeaderStyles.button} activeClassName={AppHeaderStyles.active}>
